...
function ParticleBurst(ctx, gen) {
//function ParticleBurst(pos) {

  this.ctx = ctx; 

  this.height = 1800; //canvas.height;
  this.width = 1000; //canvas.width;
  
  this.particleGenerator = new ParticleGenerator({position: pos}); 
  
  return this;
};

ParticleBurst.prototype = {
