...
var Projectile = (function () {
    ...
    var init = function (accessor) {
		var a = accessor(); 
		a['system'] = null;
		a['position'] = arguments[1]; 
		a['velocity'] = arguments[2]; 
        return function (key) {
    ...
    var projectile = function projectile(p, v) {
        var self = { }; 
        this.caller = init(function(){
            return self;
        }, p, v);
    }

    projectile.prototype = _prototype;
